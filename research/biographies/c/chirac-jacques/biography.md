...
(A small caution for the record: the official transcript of the speech renders the number of French police and gendarmes mobilized for the roundup as "450," while most reproductions, including the English-language press, give "4,500"; historians put the police mobilization for the July 1942 operation in the thousands. The exact figure Chirac spoke is genuinely disputed, which is why the enduring, uncontested lines — the seventy-four trains, the seventy-six thousand deportees, the "irreparable" — carry the weight here.)
